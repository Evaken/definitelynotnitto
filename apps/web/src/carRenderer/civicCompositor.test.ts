...
describe('Civic layered asset pack',()=>{
  it('is versioned and has independent fixed views',()=>{expect(CIVIC_ASSET_PACK).toMatchObject({id:'civic-si',schemaVersion:1,assetVersion:1});expect(Object.keys(CIVIC_ASSET_PACK.views)).toEqual(['garage','race-rear']);});
