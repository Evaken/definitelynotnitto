...
interface CarSeed {id:string;displayName:string;manufacturer:string;year:number;price:number;drivetrain:DrivetrainType;mass:number;torque:number;peakRpm:number;redline:number;gears:readonly number[];finalDrive:number;grip:number;drag:number;area:number;frontBias:number;unlockWins?:number;special?:boolean;
  /** Boost the published torque figure already includes, bar. Factory-turbo cars only. */
  factoryBoost?:number;
...
export const CORE_ROSTER:readonly Car[]=[
 ...
 car({id:'supra-tt',displayName:'Supra Twin Turbo',manufacturer:'Toyota',year:1998,price:34000,drivetrain:'RWD',mass:1560,torque:427,peakRpm:4000,redline:6800,gears:six,finalDrive:3.13,grip:1.08,factoryBoost:.72,factorySpool:2800,drag:.32,area:2.05,frontBias:.53}),
 ...
 car({id:'skyline-gtr',displayName:'Skyline GT-R',manufacturer:'Nissan',year:1999,price:42000,drivetrain:'AWD',mass:1560,torque:392,peakRpm:4400,redline:8000,gears:six,finalDrive:3.54,grip:1.14,factoryBoost:.72,factorySpool:3000,drag:.35,area:2.1,frontBias:.56}),
 car({id:'neon-srt4',displayName:'Neon SRT-4',manufacturer:'Dodge',year:2003,price:20500,drivetrain:'FWD',mass:1320,torque:339,peakRpm:3200,redline:6500,gears:five,finalDrive:3.55,grip:1.04,factoryBoost:.95,factorySpool:2500,drag:.34,area:2.08,frontBias:.64}),
