...
p('light-flywheel','Lightweight Flywheel','clutch',680,{drivelineEfficiencyDelta:.006}),p('sports-clutch','Sports Clutch','clutch',900,{drivelineEfficiencyDelta:.008,clutchHoldsTorqueRatio:1.08},[],['clutch']),p('race-clutch','Race Clutch','clutch',1650,{drivelineEfficiencyDelta:.015,clutchHoldsTorqueRatio:1.35},['sports-clutch']),p('short-shifter','Short Shifter','transmission',420,{drivelineEfficiencyDelta:.004}),p('close-ratio-gearset','Close-Ratio Gearset','transmission',2400,{allowsGearRatioTuning:true}),p('lsd','Limited-Slip Differential','transmission',1800,{tyreGripMultiplier:1.04}),
